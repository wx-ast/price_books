...
def process_order_item(data, order):
    ...
    bindings = {
        'твердый': ['7', '7бц', '7б', 'дпружинатвердый', 'переплет',
                    ...
                    'твердыйпереплет', 'твердый', 'твёрдый', 'пер',
                    'переплет8', 'перепллет', 'переплоб', 'переплобл',
                    'переплёт', 'перобл', 'перплет', 'перцвет', 'перцвилл',
                    'перёплёт', 'преплет'],
        'мягкий': ['3', 'дпружинамягкий', 'обложка', 'облц', 'обл',
                   'о', 'мяг', 'мягкаяобложка', 'мягкая', 'мягкий', 'обложа',
                   'обложка34', 'обложкапл', 'обложки', 'обложкка', 'облолжка'
                   'облпереп', 'облрожка', 'облскоба', 'обожка', 'оболожка',
                   'обоожка'],
        'картон': ['картон', '5'],
        'интегральный': ['7инт', 'интегральныйпереплетуфлак', '10',
                         'интегр', 'интегральныйпереплет', 'интегрпер'],
    }
